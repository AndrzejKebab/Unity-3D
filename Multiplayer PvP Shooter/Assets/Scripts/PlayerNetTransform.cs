...
public class PlayerNetTransform : NetworkBehaviour
{
    ...
    {
        if (!IsOwner) Destroy(transform.GetComponent<HostPlayer>());
    }
    ...
    private void ConsumeState()
    {
        ...
        transform.rotation = Quaternion.Euler(0, 0, Mathf.SmoothDampAngle(transform.rotation.eulerAngles.z, _playerState.Value.Rotation.z, ref _rotVelZ, _cheapInterpolationTime));
    }
